              ...
              <div className="relative p-8 flex flex-col h-full z-10">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="p-2 text-muted-foreground hover:text-foreground transition-colors" title="View Code">
                      <Github className="w-5 h-5" />
                    </button>
                    <button className="p-2 text-muted-foreground hover:text-foreground transition-colors" title="Live Demo">
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {project.tech.map((t) => (
                    <span key={t} className="px-3 py-1 text-xs font-semibold rounded-full bg-secondary text-secondary-foreground border border-white/5">
                      {t}
                    </span>
                  ))}
                </div>
